...
class CadastroItensEstoquePage extends StatefulWidget {
  const CadastroItensEstoquePage({super.key});

  @override
  State<CadastroItensEstoquePage> createState() => _CadastroItensEstoquePageState();
}

class _CadastroItensEstoquePageState extends State<CadastroItensEstoquePage> {
  ...
  Future<void> _cadastrarItem() async {
    ...
    final item = {
      ...
      'quantidadeAtual': int.parse(_quantidadeController.text),
    ...
    try {
      final resultado = await ApiService.cadastrarItemEstoque(item);
  ...
  Future<void> _deletarItem(ItemEstoque item) async {
    ...
    try {
      final resultado = await ApiService.deletarItemEstoque(item.id);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cadastro de Itens de Estoque'),
      ),
                  ...
                  return Card(
                    child: ListTile(
                      ...
                      subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Quantidade: ${item.quantidadeAtual}'),
